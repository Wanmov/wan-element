<template>
  ...
  >
    ...
    />
    <div class="wan-switch__core">
      <div class="wan-switch__core-inner">
        <span
          v-if="activeText || inactiveText"
          class="wan-switch__core-inner-text"
        >
          {{ checked ? activeText : inactiveText }}
        </span>
      </div>
      <div class="wan-switch__core-action"></div>
    </div>
  </div>
</template>
...
defineOptions({ name: "WanSwitch", inheritAttrs: false });
