<template>
  <div class="wan-dropdown" :class="{ 'is-disabled': props.disabled }">
    <wan-tooltip
      ref="tooltipRef"
      v-bind="tooltipProps"
    ...
    >
      <wan-button-group
        ...
        :disabled="disabled"
      >
        <wan-button @click="$emit('click', $event)">
          <slot name="default"></slot>
        </wan-button>
        <wan-button ref="triggerRef" icon="angle-down" />
      </wan-button-group>
      <slot name="default" v-else></slot>

      <template #content>
        <div class="wan-dropdown__menu">
          <slot name="dropdown">
